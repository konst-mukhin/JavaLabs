...
public class CountryController {
  ...
  @Operation(
      summary = "Delete language from country",
      description = "Enable to delete language from country")
  public void deleteLanguageFromCountry(
      @PathVariable(value = "countryId") Integer countryId,
  ...
  public CountryDto updateCountry(
      @PathVariable Integer countryId, @RequestBody Country countryDetails)
      throws BadRequestException {
